...
func newFileReadCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return file.Read(mustConfig(cmd), project, filePath, ref, output)
		},
	}
...
func newFileWriteCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return file.Write(mustConfig(cmd), project, filePath, input, message, ref)
		},
	}
	cmd.Flags().StringVar(&project, "project", "", "Project ID or path (required)")
	cmd.Flags().StringVar(&filePath, "path", "", "File path (required)")
...
func newFileListCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return file.List(mustConfig(cmd), project, path, ref)
		},
	}
	cmd.Flags().StringVar(&project, "project", "", "Project ID or path (required)")
